"""
Django settings for fancy_night_41942 project.
...
ROOT_URLCONF = 'fancy_night_41942.urls'
...
WSGI_APPLICATION = 'fancy_night_41942.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "fancy_night_41942 API",
    "DESCRIPTION": "API documentation for fancy_night_41942 App",
    "VERSION": "v1",
}
